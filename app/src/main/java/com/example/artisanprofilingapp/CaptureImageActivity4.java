...
public class CaptureImageActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capture_image4);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 10 && resultCode == RESULT_OK) {
            new CaptureImageActivity4.Encode_image().execute();
        }
    }
    ...
    private class Encode_image extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            makeRequest();
            Toast.makeText(CaptureImageActivity4.this, "picture submitted successfully!", Toast.LENGTH_LONG).show();
