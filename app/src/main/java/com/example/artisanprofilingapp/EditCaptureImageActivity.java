...
public class EditCaptureImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_capture_image);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent intent = new Intent(EditCaptureImageActivity.this, InternetCheckActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 10 && resultCode == RESULT_OK) {
            new EditCaptureImageActivity.Encode_image().execute();
        }
    }
...
//        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.43.12/Artisans-Profiling/imageupload.php",
    ...
    private boolean checkPermission() {
        ...
        int result2 = ContextCompat.checkSelfPermission(EditCaptureImageActivity.this, Manifest.permission.CAMERA);
...
//        }
        if(ActivityCompat.shouldShowRequestPermissionRationale(EditCaptureImageActivity.this, android.Manifest.permission.CAMERA)) {
            i=2;
            Toast.makeText(EditCaptureImageActivity.this, "Camera permission allows us to Click Pictures. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        }
            ...
            ActivityCompat.requestPermissions(EditCaptureImageActivity.this, new String[]{Manifest.permission.CAMERA}, PERMISSION_REQUEST_CODE);
        }
