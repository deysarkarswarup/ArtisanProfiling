...
public class EditCaptureImageActivity3 extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent intent = new Intent(EditCaptureImageActivity3.this, InternetCheckActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 10 && resultCode == RESULT_OK) {
            new EditCaptureImageActivity3.Encode_image().execute();
        }
    }
    ...
    private class Encode_image extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            makeRequest();
            Toast.makeText(EditCaptureImageActivity3.this, "picture submitted successfully!", Toast.LENGTH_LONG).show();
...
//        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.43.12/Artisans-Profiling/imageupload.php",
    ...
    private boolean checkPermission() {
        ...
        int result2 = ContextCompat.checkSelfPermission(EditCaptureImageActivity3.this, Manifest.permission.CAMERA);
...
//        }
        if(ActivityCompat.shouldShowRequestPermissionRationale(EditCaptureImageActivity3.this, android.Manifest.permission.CAMERA)) {
            i=2;
            Toast.makeText(EditCaptureImageActivity3.this, "Camera permission allows us to Click Pictures. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        }
            ...
            ActivityCompat.requestPermissions(EditCaptureImageActivity3.this, new String[]{Manifest.permission.CAMERA}, PERMISSION_REQUEST_CODE);
        }
