...
public class EditCaptureImageActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_capture_image2);
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.captureimage2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent intent = new Intent(EditCaptureImageActivity2.this, InternetCheckActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 10 && resultCode == RESULT_OK) {
            new EditCaptureImageActivity2.Encode_image().execute();
        }
    }
    ...
    private class Encode_image extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            makeRequest();
            Toast.makeText(EditCaptureImageActivity2.this, "picture submitted successfully!", Toast.LENGTH_LONG).show();

            myPref.edit().putString("track", "11").apply();
            mediaPlayer.stop();
            Intent i=new Intent(EditCaptureImageActivity2.this,EditCaptureImageActivity3.class);
            startActivity(i);
        }
    }
...
//        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.43.12/Artisans-Profiling/imageupload.php",
    ...
    private boolean checkPermission() {
        ...
        int result2 = ContextCompat.checkSelfPermission(EditCaptureImageActivity2.this, Manifest.permission.CAMERA);
...
//        }
        if(ActivityCompat.shouldShowRequestPermissionRationale(EditCaptureImageActivity2.this, android.Manifest.permission.CAMERA)) {
            i=2;
            Toast.makeText(EditCaptureImageActivity2.this, "Camera permission allows us to Click Pictures. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        }
            ...
            ActivityCompat.requestPermissions(EditCaptureImageActivity2.this, new String[]{Manifest.permission.CAMERA}, PERMISSION_REQUEST_CODE);
        }
