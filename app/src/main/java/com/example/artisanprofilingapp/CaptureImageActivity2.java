...
public class CaptureImageActivity2 extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent intent = new Intent(CaptureImageActivity2.this, InternetCheckActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 10 && resultCode == RESULT_OK) {
            new CaptureImageActivity2.Encode_image().execute();
        }
    }
    ...
    private class Encode_image extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            makeRequest();
            Toast.makeText(CaptureImageActivity2.this, "picture submitted successfully!", Toast.LENGTH_LONG).show();

            myPref.edit().putString("track", "12").apply();
            mediaPlayer.stop();
            Intent i=new Intent(CaptureImageActivity2.this,CaptureImageActivity3.class);
            startActivity(i);
        }
    }
