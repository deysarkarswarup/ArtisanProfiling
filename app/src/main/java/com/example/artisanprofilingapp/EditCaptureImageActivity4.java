...
public class EditCaptureImageActivity4 extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Intent intent = new Intent(EditCaptureImageActivity4.this, InternetCheckActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 10 && resultCode == RESULT_OK) {
            new EditCaptureImageActivity4.Encode_image().execute();
        }
    }
    ...
    private class Encode_image extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            makeRequest();
            Toast.makeText(EditCaptureImageActivity4.this, "picture submitted successfully!", Toast.LENGTH_LONG).show();

            myPref.edit().putString("track", "11").apply();
            mediaPlayer.stop();
            Intent i=new Intent(EditCaptureImageActivity4.this,EditUserChoiceActivity.class);
            startActivity(i);
        }
    }
...
//        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.43.12/Artisans-Profiling/imageupload.php",
    ...
    private boolean checkPermission() {
        ...
        int result2 = ContextCompat.checkSelfPermission(EditCaptureImageActivity4.this, Manifest.permission.CAMERA);
...
//        }
        if(ActivityCompat.shouldShowRequestPermissionRationale(EditCaptureImageActivity4.this, android.Manifest.permission.CAMERA)) {
            i=2;
            Toast.makeText(EditCaptureImageActivity4.this, "Camera permission allows us to Click Pictures. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        }
            ...
            ActivityCompat.requestPermissions(EditCaptureImageActivity4.this, new String[]{Manifest.permission.CAMERA}, PERMISSION_REQUEST_CODE);
        }
